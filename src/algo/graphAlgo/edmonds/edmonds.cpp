...
void shrinkPath(Vertex *b, Vertex *v, Vertex *w){
    ...
    while(u!=b){
        ...
        var->second = w;
        u->setBridge(var);
        u = findvx(u->getPred());if(temp==u)break;
    }
}
...
void parseBlossom(Vertex *v, Vertex *w){
    ...
    blossomBase = findvx(blossomBase);
...
/**********************************/    
    ...
    cout<<"Default graph assumed is Directed"<<endl;
